...
namespace DS.Inspectors
{
    ...
    //Might need to make DSDialogue == DialogueTrigger
    //DSDialogue == DialogueManager
    [CustomEditor(typeof(DialogueManager))]
    //probably need to search for every reference of DSDialogue and change to DialogueManager or Trigger
    public class DialogueSystemInspector : Editor
    {
        ...
        private void DrawDialogueGroupArea(DialogueSystemDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            DialogueSystemDialogueGroupSO selectedDialogueGroup = DialogueSystemIOUtility.LoadAsset<DialogueSystemDialogueGroupSO>($"Assets/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
